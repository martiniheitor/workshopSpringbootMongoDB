...
public class PostResource {
	...
	//Função para encaminhar o chamado findByTitle da classe Service
	@GetMapping(value = "/titlesearch")
	//Pode ser também a função @RequestMapping(value = "/titlesearch", method = RequestMethod.GET)
	...
	//Função para encaminhar o chamado fullSearch da classe Service
	@GetMapping(value = "/fullsearch")
	//Pode ser também a função @RequestMapping(value = "/fullsearch", method = RequestMethod.GET)
